            ...
            <div class="row g-2">
                ...
                <div class="col-md-auto">
                    ...
                    <input type="date" id="session_tgl_injek_co" wire:model.live="session_tgl_injek_co"
                        ...
                        @if (!$session_tgl_service) disabled @endif min="{{ $session_tgl_service }}" required>
                        ...
                        <div class="row">
                            <div class="col-4 text-start">
                                <div>
                                    ...
                                    {{ \Carbon\Carbon::parse($session_tgl_service)->format('d F Y') }}
                                </div>
                                <div>
                                    <strong>Tanggal Injek CO:</strong>
                                    {{ \Carbon\Carbon::parse($session_tgl_injek_co)->format('d F Y') }}
                                </div>
                            </div>
                            ...
                            @for ($i = 1; $i <= 7; $i++)
                                <th colspan="2">
                                    <select wire:model.live="selectedKategoriByproduk.{{ $i }}"
                                        ...
                                        wire:change="reloadRowsWithkategoriData">
