...
<html lang="en">
    ...
    <body>
        ...
        <table class="info-table">
            <tr>
                <td class="w-50 align-center text-left">
                    ...
                    <div class="mb-6">
                        <strong>Tanggal Injek CO</strong>: {{ $tgl_injek_co }}
                    </div>
                    <div class="mb-6">
        ...
        <table class="excel-table">
            <thead>
                <tr class="thead-bg">
                    <th class="col-bak" rowspan="5">No.</th>
                    <th colspan="9">
                        {{ $no_batch }}
                    </th>
                </tr>
            ...
            <tbody>
                @forelse (($data ?? []) as $index => $row)
                    <tr>
                        ...
                        <td>
                            {{ number_format($row['berat_loin'] ?? 0, 2) }} kg
                        </td>
                        <td>
                            {{ $row['suhu_loin'] }} °C
                        </td>
                        ...
                        @for ($i = 1; $i <= 3; $i++)
                            <td>
                                {{ number_format($row['rm_berat_' . $i] ?? 0, 2) }} kg
                            </td>
                        @endfor
                        ...
                        @for ($i = 1; $i <= 3; $i++)
                            <td>
                                {{ number_format($row['hs_berat_' . $i] ?? 0, 2) }} kg
                            </td>
                        @endfor
                    </tr>
                @empty
