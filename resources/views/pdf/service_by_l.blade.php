...
<html lang="en">
    ...
    <body>
        ...
        <table class="info-table">
            <tr>
                <td class="w-50 align-center text-left">
                    <div class="mb-6"><strong>Tanggal Service</strong>: {{ $tgl_service }}</div>
                    <div class="mb-6">
        ...
        <table class="excel-table">
            <thead>
                <tr class="thead-bg">
                    <th class="col-bak" rowspan="2">No.</th>
                    @for ($i = 0; $i < 7; $i++)
                        <th colspan="2">
                            {{ $kategori_produk->firstWhere('kategori_produk_id', $selected_kategori[$i])?->nama_produk ?? '-' }}
                        </th>
                    @endfor
                </tr>
                <tr class="thead-bg">
